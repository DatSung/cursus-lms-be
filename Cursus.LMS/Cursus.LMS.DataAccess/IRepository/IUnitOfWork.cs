...
public interface IUnitOfWork
{
    ...
    ICourseSectionVersionStatusRepository CourseSectionVersionStatusRepository { get; }
    ISectionDetailsVersionStatusRepository SectionDetailsVersionStatusRepository { get; }
