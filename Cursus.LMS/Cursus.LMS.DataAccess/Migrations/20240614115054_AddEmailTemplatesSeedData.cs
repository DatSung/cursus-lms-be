...
namespace Cursus.LMS.DataAccess.Migrations
{
    ...
    public partial class AddEmailTemplatesSeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //         { Guid.NewGuid(), "ChangePassword", "Cursus Team", "cursusservicetts@gmail.com", "Security", "Reset Your Password", "Reset your password to regain access.", "{FirstName}, {ResetLink}", "<p>Hello {FirstName},</p><p>Click <a href=\\\"{ResetLink}\\\">here</a> to reset your password.</p>", "<p>Contact us at cursusservicetts@gmail.com</p>", "<a href=\\\"{{ResetLink}}\\\">Reset Password</a>", "English", "Customer", "System", DateTime.Now, "Admin", DateTime.Now, 1 },
